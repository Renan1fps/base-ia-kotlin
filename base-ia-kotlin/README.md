...
This app was created with [Bootify.io](https://bootify.io/app/SJBG58RT8TJM) - tips on working with the code [can be found here](https://bootify.io/next-steps/).
...
```
java -Dspring.profiles.active=production -jar ./build/libs/base-ia-kotlin-0.0.1-SNAPSHOT.jar
```
...
```
gradlew bootBuildImage --imageName=io.bootify/base-ia-kotlin
```
